Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/i-mobility/RxBluetoothKit"
  ...
  s.source           = { :git => "https://github.com/i-mobility/RxBluetoothKit.git", :tag => s.version.to_s }
